...
(function () {
    const init = () => {
        try {
            ...
            const googleFonts = [
                'https://fonts.googleapis.com/css2?family=Lobster&family=Playfair+Display:ital,wght@0,400;0,700;1,400&display=swap',
                'https://fonts.bunny.net/css?family=Lobster',
                'https://fonts.bunny.net/css?family=playfair-display:400,400i,700',
            ];
