...
!(function (t, e) {
        ...
        return (
            ha(t, function (t) {
                for (var e in ((Bt[t] = ot[t] = a), (Bt[(n = t.toLowerCase())] = r), a))
                    Bt[n + ('easeIn' === e ? '.in' : 'easeOut' === e ? '.out' : '.inOut')] = Bt[
                        t + '.' + e
                    ] = a[e];
            }),
            a
        ...
        return (
            ...
            (e.kill = function kill(t, e) {
                ...
                if (this.timeline) {
                    ...
                    return (
                        this.timeline.killTweensOf(t, e, Nt && !0 !== Nt.vars.overwrite)._first ||
                            tb(this),
                        this.parent &&
    ...
    function Jd(t, e) {
        ...
        if (t in ar && n) {
            ...
            if (
                ...
                return;
            (i._gsap.svg &&
                ((this.svgo = i.getAttribute('data-svg-origin')), this.props.push(pr, e, '')),
                (t = dr));
        }
    ...
    function ee(t, e) {
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            i &&
                (Xd(a, dr),
                u && (u.svg && a.removeAttribute('transform'), kr(a, 1), (u.uncache = 1), Kd(s)));
        }
    }
    function ie(t) {
