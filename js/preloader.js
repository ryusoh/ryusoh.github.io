    ...
    class AssetPreloader {
        constructor() {
            ...
            this.assetSets = {
                ...
                p6: [
                    '/assets/img/p6/DSCF8985-2.JPG',
                    '/assets/img/p6/DSCF8978.JPG',
                    '/assets/img/p6/DSCF0283-2.jpg',
                    '/assets/img/p6/DSCF9002-2.JPG',
                    '/assets/img/p6/DSCF3362-3.jpg',
                    '/assets/img/p6/DSCF0759-2.jpg',
                    '/assets/img/p6/DSCF0548-3.jpg',
                    '/assets/img/p6/DSCF7178.JPG',
                    '/assets/img/p6/DSCF7190.JPG',
                    '/assets/img/p6/DSCF8968-2.JPG',
                    '/assets/img/p6/DSCF8998.JPG',
                    '/assets/img/p6/DSCF0324.jpg',
                    '/assets/img/p6/DSCF0658-3.jpg',
                    '/assets/img/p6/DSCF0175.jpg',
                    '/assets/img/p6/DSCF0617.jpg',
                    '/assets/img/p6/DSCF0297-3.jpg',
                    '/assets/img/p6/DSCF1119.jpg',
                    '/assets/img/p6/DSCF7202-2.JPG',
                    '/assets/img/p6/DSCF7027-6.JPG',
                    '/assets/img/p6/DSCF8873-3.JPG',
                    '/assets/img/p6/DSCF0656-2.jpg',
