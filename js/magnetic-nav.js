...
export function initMagneticNav() {
    ...
    magneticElements.forEach((el) => {
        /**
         * Bolt Optimization:
         * - What: Replace gsap.to() inside the mousemove event listener with pre-initialized gsap.quickTo() functions.
         * - Why: Calling gsap.to() on every mousemove continuously creates and destroys tween instances, triggering garbage collection pauses and CPU spikes.
         * - Impact: Significantly reduces memory churn and main thread blocking during hover interactions, ensuring smooth 60fps animations.
         */
