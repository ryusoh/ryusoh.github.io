    ...
    })(
        {
                ...
                function (e, t, n) {
                    ...
                    (['get', 'post', 'put', 'delete', 'head', 'any'].forEach(function (e) {
                        ...
                        (s.prototype.add = function (e, t, n, c) {
                            ...
                            (f.has(h.source) &&
                                i.debug('"' + t + '" resolves to same regex as existing route.'),
                                f.set(h.source, a));
                        }),
                        ...
                        (s.prototype.match = function (e) {
                            return (
                                this.matchMethod(e.method, e.url) || this.matchMethod('any', e.url)
                            );
                        }),
                        (t.exports = new s()));
                },
            ...
            15: [
                function (e, t, n) {
                    function r(e, t) {
                        for (
                            var n, r = [], o = 0, i = 0, c = '', s = (t && t.delimiter) || '/';
                            null != (n = x.exec(e));
                    ...
                    !(function () {
                        ...
                        if (t)
                            var n = t[1],
                                r = parseInt(t[2]);
                        (e &&
                            (!t || ('Firefox' === n && r >= 46) || ('Chrome' === n && r >= 50))) ||
